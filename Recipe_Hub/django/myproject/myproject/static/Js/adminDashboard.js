...
async function loadRecipes() {
  ...
  recipes.forEach((recipe) => {
    ...
    li.innerHTML = `
      <img src="${recipe.image}" alt="Recipe Image" onerror="this.src='../images/default.jpg';">
      <div>
...
async function saveRecipe() {
  ...
  if (recipeId.value) {
    formData.append("id", recipeId.value);  // مفتاح التعديل
  }
...
async function editRecipe(id) {
  ...
  document.querySelector("#preview-image").src = recipe.image;
}
...
function clearForm() {
  ...
  recipeImage.value = "";
  document.querySelector("#preview-image").src = "../images/default.jpg";
}
